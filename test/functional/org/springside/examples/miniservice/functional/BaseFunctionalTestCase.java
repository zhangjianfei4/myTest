package functional.org.springside.examples.miniservice.functional;
...
import javax.org.springside.modules.test.data.DataFixtures;
import javax.org.springside.modules.test.functional.JettyFactory;
...
public class BaseFunctionalTestCase {
	...
	protected static void startJettyOnce() throws Exception {
		if (jettyServer == null) {
			...
			jettyServer = JettyFactory.createServerInSource(new URL(baseUrl).getPort(), MiniServiceServer.CONTEXT);
			jettyServer.start();
